...
function Footer() {
  return (
    <div className="conatiner bg-light border-top">
      <div className="row p-5">
        <div className="col">
          <img src="media/logo.svg" alt="logo" style={{ width: "50%" }} className="mb-3" />
          <p>
            &copy; 2010 - 2024, Not Zerodha Broking Ltd. All rights reserved.
          </p>
          
            <a href="www.instagram.com"><i class="fa fa-instagram me-3" aria-hidden="true"></i></a>
        ...
        <div className="col ">
          <p>Company</p>
          <a href="" style={{ textDecoration: "none" }} className="text-muted mb-0.5 d-block">
            About
          </a>
          <br />
          <a href="" style={{ textDecoration: "none" }} className="text-muted mb-0.5 d-block">
      ...
      <div className=" text-muted p-5" style={{ fontSize: "12px" }}>
        <p>
